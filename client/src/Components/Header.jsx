    ...
    <div className='sticky top-0 left-0 w-full bg-gray-200 text-black h-16  px-6 z-50 shadow-md'>
      <div className='flex justify-between items-baseline max-w-6xl mx-auto p-4'>
        ...
        <ul className='flex gap-4 text-sm md:text-lg'>
          <Link to='/' className="font-serif text-black hover:text-blue-700"><li>Home</li></Link>
          <Link to='/about' className="font-serif text-black  hover:text-blue-700"><li>About</li></Link>
          <Link to='/profile' className="font-serif text-black  hover:text-blue-700">
            {currentUser ? (
